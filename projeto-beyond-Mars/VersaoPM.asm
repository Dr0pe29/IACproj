...
SELECIONA_CENARIO_SOBREPOSTO  EQU COMANDOS + 46H     ; endereço do comando para selecionar uma imagem de fundo
APAGA_CENARIO_SOBREPOSTO  EQU COMANDOS + 44H     ; endereço do comando para selecionar uma imagem de fundo
...
inicializacoes:
    ...
    MOV  [SELECIONA_CENARIO_SOBREPOSTO], R1 ; apaga cenário sobreposto
