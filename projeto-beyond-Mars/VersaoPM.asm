...
LINHA_INIC_SONDA            EQU 26
COLUNA_INIC_SONDA           EQU 32
...
; redireciona para a ação correspondente ao input
    ...
    MOV  R1, 1
    CMP  R6, R1
    JZ   comando_dispara_sonda_meio ; input = 1 - > Dispara sonda meio
    MOV  R1, 0CH
    CMP  R6, R1
...
sonda_destroi:
    CALL apaga_boneco
    MOV R1, LINHA_INIC_SONDA
    MOV R2, COLUNA_INIC_SONDA
    MOV [LINHA_SONDA], R1 
    MOV [COLUNA_SONDA], R2
    JMP sonda
